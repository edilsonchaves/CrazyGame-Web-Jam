...
show_debug_message("Begin step personagem");
isGround = check_collision(0, 1);
...
if (round(playerXVelocity) != 0)
{
	...
	var _friction_applied = sign(playerXVelocity) * friction_power;
	...
	playerXVelocity -= _friction_applied;
}
